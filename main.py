...
# ===================Python Variables=======================
menu_category = ["Tea & Coffee", "Fast Food", "South Indian", "Starters", "Main Course", "Dessert"]

menu_category_dict = {"Tea & Coffee": "1 Tea & Coffee.txt",
...
def bill_button_operation():
    ...
    if not customerContact.get().isdigit():
        ...
        return
    ans = tmsg.askquestion("Bill", "Show The Bill")
    ans = "yes"
    if ans == "yes":
        bill = Toplevel()
        bill.title("Bill")
...
root.title("Welcome to Satkar Hotel")
...
title_frame = Frame(root, bd=8, bg="skyblue", relief=GROOVE)
title_frame.pack(side=TOP, fill="x")

title_label = Label(title_frame, text="SATKAR  HOTEL",
                    font=("times new roman", 23, "bold"), bg="skyblue", fg="black", pady=5)
title_label.pack()
...
customer_name_label = Label(customer_frame, text="Name",
                            font=("arial", 15, "bold"), bg="yellow", fg="red")
...
menu_label = Label(menu_frame, text="Menu",
                   font=("times new roman", 20, "bold"), bg="yellow", fg="red", pady=0)
...
item_title_label = Label(item_frame, text="Item",
                         font=("times new roman", 20, "bold"), bg="yellow", fg="red")
...
def payment_button_operation():
    ...
    message = "Is Payment is Done Or Not ?"
...
payment_button = ttk.Button(order_frame, text="Payment", command=payment_button_operation)
